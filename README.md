...
| 🕵️ Audit logging | Record key database actions automatically |

## Highlights

- ⚡ Fast console menu for day-to-day record handling
- 🗄️ MySQL-backed storage with foreign keys and triggers
- 📜 Built-in audit trail for inserts and deletes
- 🛠️ Lightweight structure that is easy to extend
